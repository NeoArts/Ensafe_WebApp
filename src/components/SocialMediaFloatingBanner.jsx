        ...
        <div>
            <div className="social-media">
                <div className="social-media__container">
                    <a href="https://www.facebook.com/Ensafe-SAS-113297934348513" target="_blank" className="social-media__link">
                        <FontAwesomeIcon icon={faFacebookSquare} size='2x' className="social-media__icon" />
                    </a>
                    <a href="https://www.instagram.com/ensafe_sas/" target="_blank" className="social-media__link">
